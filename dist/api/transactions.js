...
export class TransactionsApi {
    ...
    async transfer(options) {
        ...
        if (validated.chain === "tempo-testnet" || validated.chain === "tempo") {
            ...
            const response = await client.request(client.api.postApiTransfersTempoRequestOpts({
    ...
    async getStatus(txHash, chain) {
        ...
        const response = await client.request(client.api.getApiTransactionsStatusByTxHashRequestOpts({
            txHash,
            ...params,
        }));
    ...
    async getHistory(options) {
        ...
        const response = await client.request(client.api.getApiTransactionsRequestOpts(params));
